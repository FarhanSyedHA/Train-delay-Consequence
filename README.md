...
- [Core Cypher Queries Explained](#core-cypher-queries-explained)
- [CognoDB Cloud Setup](#cognodb-cloud-setup)
- [Local Installation & Seeding](#local-installation--seeding)
- [Application UI & Architecture](#application-ui--architecture)
...
### Query 2: something that might be awkward in SQL
...
If we used SQL, this required joining about 6 tables across foreign keys and composite keys, whereas in a graph database, it is just one readable path pattern.
